...
for (let i of fullStack.languages) {
  console.log(i);
}

fullStack.languages.forEach((element) => {
  console.log(element);
});

for (let index = 0; index < fullStack.languages.length; index++) {
  console.log(fullStack.languages[index]);
}

for (i in fullStack.languages) {
  console.log(i);
}
...
let numeralCodes = [
  ["", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX"], // Birler
  ["", "X", "XX", "XXX", "XL", "L", "LX", "LXX", "LXXX", "XC"], // Onlar
